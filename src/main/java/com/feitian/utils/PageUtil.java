...
/**
 * @Author: feitian
 * @Date: 2018-05-03  18:01
 * @description:
 */
public class PageUtil {
    //创建Page对象
    public static PageInfo createPage(int everyPage, int totalCount, int currentPage) {//创建分页信息对象
        ...
        return new PageInfo(everyPage, totalCount, totalPage, currentPage,
